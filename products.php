...
<?php
    // Custom Setup for Products Page
    $hero_title = "The Collection";
    $hero_desc = "Curated pieces to elevate your modern living.";
    $hero_class = "cv-hero--small"; // Triggers the 60vh height
    // $hero_images = [
    //     'images/f2.jpg', // You can use different images here
    //     'images/f3.jpg'
    // ];
                ...
                <div class="filter-sidebar p-4 sticky-top">
                    ...
                    <div class="mb-4">
                        ...
                        <div id="categoryList" class="category-list">
                            <div class="category-item active" data-value="All">
                                <span>All Collections</span> <i class="fas fa-check small"></i>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="priceList">
                            <label class="form-label small text-muted d-flex justify-content-between">
                                <span>₱0</span>
                                <span id="priceValueMax" class="fw-bold text-dark">₱300,000+</span>
                            </label>
                            <input type="range" class="form-range custom-range" id="priceRange" min="0" max="300000" step="5000" value="300000">
                            
                            <div class="mt-3">
                                <div class="form-check mb-1">
                                    <input class="form-check-input" type="radio" name="pricePreset" id="priceAll" value="all" checked>
                                    <label class="form-check-label small" for="priceAll">Any Price</label>
                                </div>
                                <div class="form-check mb-1">
                                    <input class="form-check-input" type="radio" name="pricePreset" id="price1" value="0-15000">
                                    <label class="form-check-label small" for="price1">Under ₱15k</label>
                                </div>
                                <div class="form-check mb-1">
                                    <input class="form-check-input" type="radio" name="pricePreset" id="price2" value="15000-50000">
                                    <label class="form-check-label small" for="price2">₱15k - ₱50k</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="pricePreset" id="price3" value="50000-1000000">
                                    <label class="form-check-label small" for="price3">Premium (₱50k+)</label>
                                </div>
                            </div>
                        </div>
                    </div>
